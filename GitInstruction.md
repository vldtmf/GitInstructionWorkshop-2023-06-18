...
// Обязательно к запоминанию команды git log, git log --graph, git log --online --all

## Работа с удаленными репозиториями.

### Что такое удаленный репозиторий и для чего он нужен
// Удаленный репозиторий это отдельный репозиторий на GitHub, необходим для организации совместной работы, для работы над одним проектом.
